...
public class CloudflareR2ImageFileService implements RemoteFileService {
    ...
    public String uploadFile(MultipartFile file, String filePath) {
        try {
            ...
            return imagePublicUrl + "/" + filePath;
        } catch (IOException e) {
            throw new DuckwhoException(ErrorCode.FILE_ERROR);
        }
    }
    ...
    public void deleteDirectory(String path) {
        try {
            ...
            if (!keysToDelete.isEmpty()) {
                DeleteObjectsRequest deleteObjectsRequest = new DeleteObjectsRequest(imageBucket)
